...
const pricingFeaturesSection = {
  ...
  pricing: {
    ...
    description:
      "Get a fully managed, stunning portfolio website with zero capital outlay. We handle the hosting, code management, and domain so you can focus on building your brand.",
...
const portfolioSection = {
  ...
  sites: [
    { title: "Poolware and Service",    url: "https://www.poolwareandservice.co.za"   },
    { title: "Homeloans and Bonds",     url: "https://www.homeloansandbonds.co.za"    },
    { title: "Evo Ultimate",            url: "https://www.evoultimate.co.za"          },
    { title: "Bond Squad",              url: "https://www.bondsquad.co.za"            },
    { title: "Apex Leadership",         url: "https://www.apexleadership.co.za"       },
    { title: "Blue Key Home Finance",   url: "https://www.bluekeyhomefinance.co.za"   },
    { title: "First Class Finance SA",  url: "https://www.firstclassfinancesa.co.za"  },
    { title: "VM Home Loans",           url: "https://www.vmhomeloans.co.za"          },
    { title: "Apex Leadership Next",    url: "https://apex-leadership-next.vercel.app" },
    { title: "Ceyoni Physio",           url: "https://phys-ceyo.vercel.app"           },
    { title: "Sterling Crest Bonds",    url: "https://www.sterlingcrestbonds.co.za"   },
    { title: "The Bond Studio",         url: "https://www.thebondstudio.co.za"        },
    { title: "Captivating Places",      url: "https://www.captivatingplaces.co.za"    },
    { title: "Intellify",               url: "https://www.intellify.co.za"            },
  ],
}
...
const portfolioPageSection = {
  ...
  header: {
    ...
    description:
      "If customers can't easily find you, you will lose business. We move fast, we optimize, and we assist in how you think about your business. We are the perfect fit.",
  },
  plan: {
    ...
    description:
      "Everything you need to establish a professional, high-performing website without the massive capital expense.",
  ...
  features: [
    {
      ...
      description:
        "We understand that building a website can be overwhelming and a huge capital expense. We have you covered. With NO upfront fees or lump sums you can go online at a low monthly cost. We carry the risk, you carry the benefit.",
    },
    {
      title: "Domain registration included",
      description:
        "Your online journey starts with a Domain Name! We make this part easy and its included in your monthly fee that also includes the annual renewal.",
    },
    {
      title: "Fully Cloud-Managed & Secure",
      description:
        "We handle all the technical heavy lifting—from state-of-the-art cloud hosting to complete codebase management and seamless feature updates. You get enterprise-grade reliability without needing an IT degree.",
    },
    {
      title: "Monthly hosting costs included",
      description:
        "Hosting is a kind of rent you pay for your website to be on a server. You don't have to worry about finding standard prices, because its fully included.",
    },
  ],
  quote: {
...
export const site = {
  ...
  pricingFeatures: pricingFeaturesSection,
  portfolio: portfolioSection,
  portfolioPage: portfolioPageSection,
