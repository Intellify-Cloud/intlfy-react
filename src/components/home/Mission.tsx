...
interface MissionProps {
  ...
  subtitle: string
  paragraphs: string[]
  features: SiteConfig["home"]["mission"]["features"]
}

export const Mission = ({ title, highlight, subtitle, paragraphs, features }: MissionProps) => {
  return (
...
const FeatureCardContent = ({
  ...
  feature: SiteConfig["home"]["mission"]["features"][number]
  description: string
}) => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div
        className={`flex-1 rounded-2xl bg-gradient-to-br ${feature.gradientFrom} ${feature.gradientTo} p-6 flex items-center`}
      >
