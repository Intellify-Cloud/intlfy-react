...
export const Portfolio = ({ title, sites }: PortfolioProps) => {
  return (
    <div className="py-24 px-6 bg-gray-50 dark:bg-neutral-900/50 w-full border-t border-gray-200 dark:border-neutral-800">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {sites.map((site, idx) => {
            // Using WordPress mshots API to dynamically generate website screenshots for free
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-video w-full overflow-hidden bg-gray-100 dark:bg-neutral-800">
                  ...
                  {/* Uniform Tint Overlay (disappears on hover) */}
                  <div className="absolute inset-0 bg-slate-900/10 dark:bg-black/30 mix-blend-multiply dark:mix-blend-normal group-hover:opacity-0 transition-opacity duration-500 pointer-events-none"></div>
